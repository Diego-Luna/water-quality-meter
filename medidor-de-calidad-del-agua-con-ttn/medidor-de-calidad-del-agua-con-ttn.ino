...
void  ft_send_data()
{
  ...
  send_values = send_values + value_Water_Tem;
  ...
  Serial.println();
  Serial.print("Sending: " + send_values + " - ");
  for (unsigned int i = 0; i < send_values.length(); i++) {
    Serial.print(send_values[i] >> 4, HEX);
    Serial.print(send_values[i] & 0xF, HEX);
    Serial.print(" ");
  }
  Serial.println();
